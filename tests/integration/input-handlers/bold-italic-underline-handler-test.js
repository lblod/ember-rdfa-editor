...
module.skip(
  'Integration | InputHandler | bold-italic-underline-handler',
  function (hooks) {
    ...
    />`);
      ...
      await triggerKeyEvent('div[contenteditable]', 'keydown', 66, {
        ctrlKey: true,
      });
    ...
    />`);
      ...
      window.getSelection().selectAllChildren(editor);
      click('div[contenteditable]');
      await triggerKeyEvent('div[contenteditable]', 'keydown', 73, {
        ctrlKey: true,
      });
    ...
    />`);
      ...
      window.getSelection().selectAllChildren(editor);
      click('div[contenteditable]');
      await triggerKeyEvent('div[contenteditable]', 'keydown', 85, {
        ctrlKey: true,
      });
