...
module('Unit | model | twoway-conversion', function (hooks) {
  ...
  test('converting simple tree back and forth gives same tree', function (assert) {
  ...
  test('<i> gets converted to <em>', function (assert) {
    const p = document.createElement('p');
