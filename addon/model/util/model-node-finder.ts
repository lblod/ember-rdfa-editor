...
import NodeFinder, {
  NodeFinderFilter,
  NodeFinderPredicate,
} from '@lblod/ember-rdfa-editor/model/util/node-finder';

export type ModelNodeFinderFilter<R extends ModelNode> = NodeFinderFilter<
  ModelNode,
  R
>;
export type ModelNodeFinderPredicate<R extends ModelNode> = NodeFinderPredicate<
  ModelNode,
  R
>;
/**
 ...
 */
export default class ModelNodeFinder<
  R extends ModelNode = ModelNode
> extends NodeFinder<ModelNode, R> {
