...
import { ElementType } from '@lblod/ember-rdfa-editor/core/model/nodes/model-element';
import readHtmlList from '@lblod/ember-rdfa-editor/core/model/readers/html-list-reader';
import {
  isElement,
  isTextNode,
  tagName,
} from '@lblod/ember-rdfa-editor/utils/dom-helpers';
import readHtmlText from '@lblod/ember-rdfa-editor/core/model/readers/html-text-reader';
import readHtmlTable from '@lblod/ember-rdfa-editor/core/model/readers/html-table-reader';
import readHtmlSpan from '@lblod/ember-rdfa-editor/core/model/readers/html-span-reader';
