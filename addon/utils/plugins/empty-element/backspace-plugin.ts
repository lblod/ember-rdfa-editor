import { BackspacePlugin,
         ...
         moveCaretBefore,
         MoveCursorToEndOfNodeManipulation} from '../../ce/handlers/backspace-handler';
/**
...
export default class EmptyElementBackspacePlugin implements BackspacePlugin {
   ...
   */
  jumpBeforeAndRemoveEmptyElement( manipulation: MoveCursorToEndOfNodeManipulation, editor: Editor) {
