...
export type ArInsertFunc = (arDesign: ArDesign, insertPosition: ArticleInsertPosition, skipWarnings?: boolean) => void;
...
export type ProcessDocumentHeadlessly = (html: string, transactionGenerator: (state: EditorState) => TransactionCombinatorResult<boolean>) => string;
