...
- [#1399](https://github.com/lblod/ember-rdfa-editor/pull/1399) [`e9240f9`](https://github.com/lblod/ember-rdfa-editor/commit/e9240f95d94c8adcd28ca11bcb300c0b676bc4c9) Thanks [@lagartoverde](https://github.com/lagartoverde)! - Add argument to build article structure function to build RB articles and improve selection handling when inserting articles freely
...
- [#1365](https://github.com/lblod/ember-rdfa-editor/pull/1365) [`19f2fba`](https://github.com/lblod/ember-rdfa-editor/commit/19f2fbaf3b62dbd0edbf6aebba3b184a7751d9bc) Thanks [@elpoelma](https://github.com/elpoelma)! - list_item node: take possible empty `listPath` attributes into account. This can occur in the rare instance where `toDOM` is called on a `list_item` node that has not yet its `listPath` calculated (for example `list_item` nodes auto-generated by prosemirror)

- [`4d0d8b1`](https://github.com/lblod/ember-rdfa-editor/commit/4d0d8b1470c7261c8f35e1a704e3f3807e9fa93c) Thanks [@kobemertens](https://github.com/kobemertens)! - Close link popover on escape key keydown instead of keyup
...
- [#1340](https://github.com/lblod/ember-rdfa-editor/pull/1340) [`7e6de75`](https://github.com/lblod/ember-rdfa-editor/commit/7e6de75995d22a8ba62472de0fd9f9b3fdf617c1) Thanks [@abeforgit](https://github.com/abeforgit)! - Add new semantic html string comparison assertion

- [#1343](https://github.com/lblod/ember-rdfa-editor/pull/1343) [`10127b5`](https://github.com/lblod/ember-rdfa-editor/commit/10127b51e87b8dfa54d28a80b77140906bef19ad) Thanks [@elpoelma](https://github.com/elpoelma)! - Add support for model migrations to `block_rdfa` node

- [#1340](https://github.com/lblod/ember-rdfa-editor/pull/1340) [`7e6de75`](https://github.com/lblod/ember-rdfa-editor/commit/7e6de75995d22a8ba62472de0fd9f9b3fdf617c1) Thanks [@abeforgit](https://github.com/abeforgit)! - Move all dependencies to pnpm catalogs

### Patch Changes

- [#1340](https://github.com/lblod/ember-rdfa-editor/pull/1340) [`7e6de75`](https://github.com/lblod/ember-rdfa-editor/commit/7e6de75995d22a8ba62472de0fd9f9b3fdf617c1) Thanks [@abeforgit](https://github.com/abeforgit)! - bump dependencies
